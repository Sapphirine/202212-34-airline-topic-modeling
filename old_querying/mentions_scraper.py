...
def main_united():
    ...
    # DELTA
    page_counter = 105  # TODO: Adjust manually for the time being!!!!
    until_id = "1595532284463046677"  # TODO: Take "oldest_id" from your most recent response json
    max_counter = 200  # TODO: Adjust manually for the time being!!!!
